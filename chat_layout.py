...
class Example(wx.Frame):
    ...
    def InitUI(self):
    	...
    	online = wx.StaticText(panel, label="Online People")
    	...
    	fgs.AddMany([(online), (r_msg), (self.txt_online, 1, wx.EXPAND), (self.txt_recieve, 1, wx.EXPAND),(self.group) ,(s_msg),(blank3) ,(self.txt_send, 1, wx.EXPAND), (blank2), (self.btn)])
